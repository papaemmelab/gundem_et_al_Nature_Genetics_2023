...
relapses = read.table('data/evolutionary_patterns_relapses.txt', header=T, sep="\t", stringsAsFactors=F)
...
pdf('raw/figure7ab.pdf', height=4, width=12)
...
pdf('raw/figure7b_inside.pdf', height=4, width=4)
